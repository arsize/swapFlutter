...
class UserFrequencyCardRecord {
  ...
  UserFrequencyCardRecord({
    ...
    required this.additionalMoneyDiscountAmount,
    required this.batteryTypeId,
    required this.buyType,
    required this.canUpgraded,
    required this.couponDiscountAmount,
    required this.frequencyCardCategory,
    required this.frequencyCardContractPeriod,
    required this.frequencyCardId,
    required this.frequencyCardName,
    required this.frequencyCardNum,
    required this.frequencyCardPrice,
    required this.frequencyCardType,
    required this.id,
    required this.loseEffectTime,
    required this.numberOfFulfilledContracts,
    required this.oldFrequencyCardId,
    required this.orderNumber,
    required this.organizationId,
    required this.payType,
    required this.status,
    required this.surplusNum,
    required this.takeEffectTime,
  });
  ...
  UserFrequencyCardRecord copyWith({
    ...
    return UserFrequencyCardRecord(
      ...
      additionalMoneyDiscountAmount: additionalMoneyDiscountAmount ?? this.additionalMoneyDiscountAmount,
      ...
      frequencyCardCategory: frequencyCardCategory ?? this.frequencyCardCategory,
      frequencyCardContractPeriod: frequencyCardContractPeriod ?? this.frequencyCardContractPeriod,
      ...
      numberOfFulfilledContracts: numberOfFulfilledContracts ?? this.numberOfFulfilledContracts,
  ...
  factory UserFrequencyCardRecord.fromMap(Map<String, dynamic> map) {
    return UserFrequencyCardRecord(
      ...
      additionalMoneyDiscountAmount: map['additionalMoneyDiscountAmount']?.toInt(),
  ...
  factory UserFrequencyCardRecord.fromJson(String source) => UserFrequencyCardRecord.fromMap(json.decode(source));
